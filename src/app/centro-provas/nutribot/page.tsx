...
function resposta(pergunta: string) {
  ...
  if (q.includes("mistura") && q.includes("velocidade")) return "🌾 **Mistura de referência — Velocidade (10kg):**\n• 4kg milho pequeno\n• 2,5kg trigo\n• 2kg sorgo\n• 1kg ervilha\n• 0,5kg girassol\n\n⚗️ Mix Final do protocolo: **5g/pombo na quinta-feira**. Ajuste ao consumo, clima e condição corporal.";
  if (q.includes("mistura") && q.includes("fundo")) return "🌾 **Mistura de referência — Fundo (10kg):**\n• 3kg milho\n• 2kg ervilha\n• 1,5kg trigo\n• 1,5kg girassol\n• 1kg sorgo\n• 0,5kg amendoim\n• 0,5kg linhaça\n\n⚗️ Mix Final: **10g/pombo** no protocolo de fundo. Faça a transição gradualmente.";
